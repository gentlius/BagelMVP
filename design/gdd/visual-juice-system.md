...
| `SFX_GAIN` | 0.5 | 0.4–0.8 | SFX bus 전체 감쇠 (-6 dBFS). per-SFX volume 비율은 §Audio Note Mix 표 유지. critical-pop 3-layer composite + SFX transient 인지 hot 보정 — BGM이 SFX critical보다 약간 우위가 되도록 (D-P6-AUDIO-FIX) |
