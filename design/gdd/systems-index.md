...
| 2 | Balloon Physics & Split System | Gameplay | Not Started | balloon-physics-split-system.md | Input System |
| 3 | Critical Pop System | Gameplay | Not Started | critical-pop-system.md | Balloon Physics |
| 4 | Score & Combo System | Gameplay | Not Started | score-combo-system.md | Balloon Physics, Critical Pop |
...
|--------|-------|
| Total systems | 5 |
| Design docs designed | 1 (Input) |
| Design docs in progress | 0 |
| Design docs Not Started | 4 (Balloon Physics, Critical, Score & Combo, Visual Juice) |
...
- [ ] `/design-system balloon-physics-split-system` — 1-pager 100-200줄. character-harpoon + difficulty-spawn 흡수
- [ ] `/design-system critical-pop-system` — 1-pager 100-150줄. Pity timer + rng.critical
- [ ] `/design-system score-combo-system` — 1-pager 80-100줄
